...
from MSACES_NewPart import VueNewPart, VueEditPartFilled
...
class TestNewPart_VueNewPart(unittest.TestCase):
    ...
    # @classmethod
    # def setUpClass(cls):
    #     print("set up class test_NewPart")
    '''Class methods happen once per class
    #I.E. they happen at the very beginning and end
    #Not before/after each test, but once per TestNewPart'''
    # @classmethod
    # def tearDownClass(cls):
    #     print("tear down class test_NewPart")
    ...
    def test_filledpwBolt_Exception1(self):
        # self.form.LE_Mat.setText("517") #A286
        self.form.LE_Diam.setText("1.26")
        self.form.LE_Shank.setText("1.5")
        ...
        with self.assertRaises(TypeError):
            self.form.unsafe_filledpw()


        self.assertFalse(self.form.isStudBox.isChecked())
        self.assertFalse(self.form.isNutBox.isChecked())

    def test_filledpwBolt_Exception2(self):
        self.form.LE_Mat.setText("517") #A286
        # self.form.LE_Diam.setText("1.26")
        self.form.LE_Shank.setText("1.5")
    ...
    def test_filledpwBolt_Exception3(self):
        self.form.LE_Mat.setText("517") #A286
        self.form.LE_Diam.setText("1.26")
        # self.form.LE_Shank.setText("1.5")
...
class TestNewPart_VueEditPartFilled_Bolt(unittest.TestCase):
    ...
    def setUp(self):
        ...
        isNut = False
        isStud = False
        self.form = VueEditPartFilled(parent,partnumber, description, revision, mfgspec, estby, date, mat,headop, diam, shank, note, ops, isNut, isStud, isNoBid, NoBidNote)
